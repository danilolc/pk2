...
const int SCREEN_BPP			= 32;	// Älä koske!
...
char Running_viesti[2]	= " ";  // ei vielä (kunnolla) käytössä
...
// Kaiken alku ja juuri: main. Tästä se kaikki alkaa ja tämän sisällä peli pyörii.
