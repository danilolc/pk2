//#########################
//Pekka Kana 2 Sprite Creator
//by Janne Kivilahti from Piste Gamez
//---------------
//To create the .spr files from .bmp and .wav
//Doesn't working yet
//#########################
...
/*
	...
	luo_prototyyppi_kani(				"sprites\\rabbit.spr");		//aanet paivitetty - update 2!
	luo_prototyyppi_kani2(				"sprites\\rabbit2.spr");	//aanet paivitetty - update 2!
...
/*	luo_prototyyppi_possu(				"sprites\\pig.spr");
	...
	luo_prototyyppi_pommi(				"sprites\\bomb.spr");	// paivitetty - update 2!
	...
	luo_prototyyppi_jattihiiri2(		"sprites\\gmouse2.spr"); // paivitetty - update 1!
...
/*
	...
	// TAUSTASPRITET
	luo_prototyyppi_tausta_kukka1(		"sprites\\bg_flwr1.spr");	// paivitetty - update 1!
	...
	luo_prototyyppi_perhonen(			"sprites\\bttrfly.spr");	// paivitetty - update 1!
	luo_prototyyppi_perhonen2(			"sprites\\bttrfly2.spr");	// paivitetty - update 1!
...
/*
	...
	*/
	...
	luo_prototyyppi_sammakko4(			"sprites\\frog4.spr");		//uusi! - update 2!
	luo_prototyyppi_sammakko5(			"sprites\\frog5.spr");		//uusi! - update 2!
	luo_prototyyppi_hyppija(			"sprites\\jumper.spr");		//aanet paaivitetty - update 2!
	luo_prototyyppi_hyppija2(			"sprites\\jumper2.spr");	//aanet paaivitetty - update 2!
	luo_prototyyppi_kani(				"sprites\\rabbit.spr");		//aanet paaivitetty - update 2!
	luo_prototyyppi_kani2(				"sprites\\rabbit2.spr");	//aanet paaivitetty - update 2!
	luo_prototyyppi_pommi(				"sprites\\bomb.spr");	// paivitetty - update 2!
	luo_prototyyppi_jattihiiri2(		"sprites\\gmouse2.spr"); // paivitetty - update 1!
	luo_prototyyppi_mehilainen3(		"sprites\\bee3.spr");	// uusi - update 1!
