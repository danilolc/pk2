...
const UCHAR BLOCK_ESTO_ALAS		= 40;
const UCHAR BLOCK_HISSI_HORI		= 41;
const UCHAR BLOCK_HISSI_VERT		= 42;
const UCHAR BLOCK_KYTKIN2_YLOS	= 43;
const UCHAR BLOCK_KYTKIN2_ALAS	= 45;
const UCHAR BLOCK_KYTKIN3_OIKEALLE = 44;
const UCHAR BLOCK_KYTKIN3_VASEMMALLE = 46;
const UCHAR BLOCK_LUKKO			= 47;
const UCHAR BLOCK_KALLOSEINA		= 48;
const UCHAR BLOCK_KALLOTAUSTA		= 49;
const UCHAR BLOCK_ANIM1			= 60;
const UCHAR BLOCK_ANIM2			= 65;
const UCHAR BLOCK_ANIM3			= 70;
const UCHAR BLOCK_ANIM4			= 75;
const UCHAR BLOCK_VIRTA_VASEMMALLE= 140;
const UCHAR BLOCK_VIRTA_OIKEALLE	= 141;
const UCHAR BLOCK_VIRTA_YLOS		= 142;
const UCHAR BLOCK_PIILO			= 143;
const UCHAR BLOCK_TULI			= 144;
const UCHAR BLOCK_KYTKIN1			= 145;
const UCHAR BLOCK_KYTKIN2			= 146;
const UCHAR BLOCK_KYTKIN3			= 147;
const UCHAR BLOCK_ALOITUS			= 148;
const UCHAR BLOCK_LOPETUS			= 149;
